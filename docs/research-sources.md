...
| [Onshape Revolve](https://cad.onshape.com/help/Content/PartStudio/revolve.htm) | Region and axis selection, full and bounded angles, direction modes, and New/Add/Remove/Intersect modeling intent used to bound the first VibeShape Revolve slice |
