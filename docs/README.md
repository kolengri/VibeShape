...
- Signed offset Datum Plane features are semantic reference geometry; they can support sketches but never become manufacturing bodies or export objects.
