...
- a specialized SVG sketch canvas that receives one schema-valid analytical draft, delegates mutations and deterministic point/axis inference to pure domain operations, exposes entity and stable-region selection, renders constraint and authored-dimension glyphs, and keeps solved display geometry disposable;
