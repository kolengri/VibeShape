...
| Package manager | pnpm workspaces | строгие зависимости и удобный monorepo |
...
| Tests | Vitest + Playwright | unit/property tests и реальные browser flows |
...
Начать с небольшого набора accessible headless primitives и CSS variables/CSS Modules. Не привязывать command/domain model к конкретной design system. Tailwind, Radix или React Aria выбираются отдельным коротким spike по accessibility, bundle и ergonomics после geometry P0.
