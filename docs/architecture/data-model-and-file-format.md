...
- a bounded coplanar sketch-to-sketch external point-reference foundation with stable source/projected IDs, read-only fixed solver points, source-removal protection, and no serialized solved coordinates;
