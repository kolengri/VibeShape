...
- `org.vibeshape.document.create`, `org.vibeshape.document.rename`, variable add/expression-update/remove, feature add/update, and feature suppression command schema version 1;
