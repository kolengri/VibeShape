...
Create a variable-driven rectangle and exact new-body extrusion, edit its driving variable after reopen, combine primitive solids with a Boolean, recover the project offline, round-trip a `.vshape` backup into fresh browser storage, and export STEP/STL.
