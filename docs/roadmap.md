...
- Extend the implemented explicit-target Revolve beyond origin and same-sketch line axes with stable model-edge and connector axes plus additional end conditions; add a dedicated Pocket workflow after the shared preview and target-selection contracts stabilize.
