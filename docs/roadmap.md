...
The Extrusion-face support claim includes caps and line-generated planar sides with stable `extrusion.side.<sourceEntityId>` roles. General unannotated planar B-Rep faces and guided support repair remain open.
