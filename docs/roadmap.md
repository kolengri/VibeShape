...
- Unit-aware inputs.
- Extend the implemented expression-capable Box parameter pattern to sketch dimensions and feature editing, including variable-reference insertion rather than manual typing alone.
...
- Rich expressions (`^`, functions, compound dimensions) and atomic variable rename/refactor.
