...
- Extend the implemented explicit-target, origin-axis Revolve with selected stable axes and additional end conditions; add a dedicated Pocket workflow after the shared preview and target-selection contracts stabilize.
