...
| External selection | Use external geometry selects earlier sketch points, lines, and analytical curves in 2D or the persistent 3D viewport with source labels. Passive, selectable, and committed layers are mutually exclusive. | Add graphical feature-topology candidates, source filters, and overlap cycling. | P0 |
