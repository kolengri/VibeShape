...
Visible earlier sketch points and analytical curves now remain as muted normal-view context during downstream sketch editing and obey model-tree visibility. Circular, arc, and ellipse centers use distinct square control markers. **Use** promotes earlier points and lines in the normal or persistent 3D view, and graph-ordered point-and-line reference chains recursively resolve earlier solved source intent. Curved Use materialization, feature-edge Use, and user-facing chain repair remain open.
