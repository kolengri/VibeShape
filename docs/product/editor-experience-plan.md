...
- Existing-point, segment-midpoint, bounded segment-intersection, point-on-line, point-to-point horizontal/vertical alignment, line direction, parallel, perpendicular, and endpoint-tangent candidates now provide inference guides and accepted persistent constraints. Alignment can target distant authored points or passively woken stable external points without activating Use. Arc midpoint/quadrant candidates and remaining projected geometry remain open.
