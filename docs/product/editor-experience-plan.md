...
|---|---|---|
| Onshape | A stable graphics area, feature list, contextual sketch toolbar, compact Accept/Cancel lifecycle, direct canvas constraints, secondary diagnostic Constraint manager, and direct Extrude/Revolve that accepts the open sketch first | Keep the viewport and model tree stable; keep X/Finish and diagnostics compact in the sketch task header; keep profile features only in the toolbar; create and edit constraints primarily on the canvas |
