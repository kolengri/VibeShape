...
- Existing-point, segment-midpoint, bounded segment-intersection, point-on-line, point-to-point horizontal/vertical alignment, exact circle or bounded-arc quadrant, line direction, parallel, perpendicular, and endpoint-tangent candidates now provide inference guides and accepted persistent constraints. Alignment and quadrant intent can target authored geometry or passively woken stable external points and curves without activating Use. Arc midpoint candidates and remaining projected geometry remain open.
