...
- Enter a normal-to-plane orthographic camera only after the support is valid.
- Add Escape, invalid-selection guidance, keyboard traversal, and touch-sized selection targets.
