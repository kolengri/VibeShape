...
2. The revisioned feature DAG gains authoritative content hashes, worker-backed evaluation, topology repair events, and save/reopen rebuild coverage over the accepted `TopoRef` and downstream-failure contracts.
