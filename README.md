...
2. The revisioned feature DAG connects feature-type eligibility and normalized primitive parameters to authoritative content hashes, worker-backed evaluation, topology repair events, and save/reopen rebuild coverage over the accepted `TopoRef` and downstream-failure contracts.
