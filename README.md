...
1. SPK-004 produces validated local 3MF output that opens in at least PrusaSlicer and Cura/OrcaSlicer.
...
3. The production feature DAG integrates the accepted `TopoRef` contract, downstream failure propagation, repair events, and save/reopen rebuild coverage.
4. The production geometry facade is selected from the measured OCCT spike boundaries.
