...
The initial local-project library now reads bounded, strict IndexedDB summaries, identifies the current project, creates a new project, and switches between existing projects by stable document ID. Preview cards, duplication, and confirmed deletion remain required before the P0 library is complete.
