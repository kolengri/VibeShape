...
2. Connect the revisioned feature DAG to the protocol-v6 primitive worker path, then extend it from dependency-free box/cylinder evaluation to dependent features, topology repair events, and save/reopen rebuild coverage over the accepted `TopoRef` and downstream-failure contracts.
