...
1. Extend the implemented interactive sketch-to-new-body flow with viewport plane picking, inference and constraint glyphs, intersection splitting, multi-region feature input, add/remove/intersect body operations, and interactive solid preview.
