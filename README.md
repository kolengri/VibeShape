...
5. Extend `.vshape` v0 with migrations, explicit same-ID restore/copy policy, backup reminders, bulk export, and progressive system pickers; continue persistence work with autosave scheduling policy, BroadcastChannel coordination, persistent cache promotion, and an installed-build update gate.
