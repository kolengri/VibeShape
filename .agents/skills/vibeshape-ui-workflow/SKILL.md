...
4. Define idle, hover, focus, selected, disabled, preview, loading, error, success, and cancellation states.
5. Preserve one command implementation across toolbar, menu, palette, context menu, and shortcut.
6. Add keyboard behavior, accessible name, description, validation, focus restoration, and status announcement with the component.
7. Verify dark and light themes, 1024 px authoring width, 200% zoom, reduced motion, and long English source copy.
